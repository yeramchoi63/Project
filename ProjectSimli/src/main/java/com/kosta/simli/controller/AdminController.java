...
public class AdminController {
	...
	public String admin_booking(HttpServletRequest request) {
		
		return "admin.admin_booking.admin_Booking";
	}
	
	@RequestMapping("/admin_Booking_Detail")
	public String admin_Booking_Detail(HttpServletRequest request) {
		
		AdminDAO dao = sqlSession.getMapper(AdminDAO.class);	
		
		String appointday = request.getParameter("appointday");
		List<ReserDTO> reserList = dao.reserList(appointday);		
