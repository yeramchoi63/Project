...
<body>
	...
	<form action="adminmember_modify" method="post" name="input" onSubmit="return checkInfo()">
		...
		<table border="1">
			...
			<c:forEach items="${ list  }" var="list">
				...
				<tr>
					<td>ID</td>
					<td>${ list.id }<font color="red">&nbsp;[수정불가]</font>
				...
				<tr>
					<td>비밀번호</td>
					<td><input type="text" name="pwd" size="21" maxlength="12" value="${ list.pwd }">
					</td>
				</tr>

				<tr>
					<td>비밀번호 확인</td>
					<td><input type="password" name="pwd2" size="21" maxlength="12"></td>
				</tr>
				...
				<tr>
					...
					<script type="text/javascript">
					 ...
					 - <input type="text" size="2" value="${ phone2 }" name="phone2">
				...
				<tr>
					<td>주소</td>
					<td><input type="text" name="addr" size="50" value="${ list.addr }">
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
						...
						<a href="${pageContext.request.contextPath}/adminpage_view">취소</a>
					</td>
				</tr>
